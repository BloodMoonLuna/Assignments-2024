...
#Task 1: Grocery Store Math Calculate the total cost of three items you'd commonly find in a grocery store, given their individual prices./ 
# For example, what would be the cost of bread, peanut butter, and jelly be? Prices don't need to be realistic!

bread = 5
peanut_butter = 3
jelly = 2
grocery_total = bread + peanut_butter + jelly
print(grocery_total)
...
savings = 10000
intrest_rate = 0.07
intrest_earned = savings * intrest_rate
total = savings + intrest_earned
print(total)